...
// //load chunks one by one into vbos and alloced memory. Use SQL to manage chunks in file
...
//     // {
//     //     if(is_chunk_too_far_away(chunk_system->dchunks[i].x, chunk_system->dchunks[i].y, player.x, player.y))
//     //     {
//     //         free_chunk(&chunk_system->dchunks[i]);
//     //     }
//     // }
// }
